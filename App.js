            ...
            <NavigationContainer>
                <Stack.Navigator 
                    ...
                    screenOptions={{
                        ...
                        headerTitleStyle: { fontFamily: 'AveriaLibre-Regular', color: '#FFFFFF', fontSize: 22}
                    }}
                >
                    ...
                    <Stack.Screen name="AcaoPesquisa" component={AcaoPesquisa} options={({ route }) => ({ headerTitle: route.params?.pesquisa?.nome || 'Pesquisa'})} />
